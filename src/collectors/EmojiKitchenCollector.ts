...
import { updateEmojiKitchen, setEmojiKitchenError } from "../caches/EmojiKitchenCache.ts";
...
export async function collectEmojiKitchen() {
  try {
    ...
    await saveState("emoji_kitchen_metadata", metadata as unknown as Record<string, unknown>);
