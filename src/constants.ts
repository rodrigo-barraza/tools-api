...
export const MOON_PHASE_INTERVAL_MS = 3_600_000; // 1 hour
...
// Re-exported from @rodrigo-barraza/utilities-library for backwards compatibility
export {
  WORKSPACE_MAX_READ_BYTES as AGENT_FILE_MAX_READ_BYTES,
  WORKSPACE_MAX_WRITE_BYTES as AGENT_FILE_MAX_WRITE_BYTES,
  WORKSPACE_MAX_LINES_PER_READ as AGENT_FILE_MAX_LINES_PER_READ,
  WORKSPACE_MAX_GREP_RESULTS as AGENT_FILE_MAX_GREP_RESULTS,
  WORKSPACE_MAX_GLOB_RESULTS as AGENT_FILE_MAX_GLOB_RESULTS,
  WORKSPACE_MAX_DIRECTORY_ENTRIES as AGENT_FILE_MAX_DIR_ENTRIES,
  WORKSPACE_MAX_PREVIEW_BYTES as AGENT_FILE_MAX_PREVIEW_BYTES,
