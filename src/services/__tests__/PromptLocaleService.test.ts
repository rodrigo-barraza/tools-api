...
describe("PromptLocaleService — Common Params Shared Keys", () => {
  ...
  const COMMON_PARAMS_KEYS = [
    ...
    { key: "tools.common.params.backgroundColorDefault", expectedValue: "Background color (default: '#4c4c4c' neutral viewport grey; create_3d_scene derives it from the environment preset)" },
